            ...
            <Container>
                <div
                    ...
                    <div className="flex items-center">
                        <Image src="/logo.png" alt="logo" className="md:w-full w-20" width={100} height={100} /> <span className="md:ml-2 text-4xl md:text-5xl">Programming</span>
                    </div>
                    <ul className="flex flex-wrap items-center justify-center gap-y-2 gap-x-8">
                        ...
                        <li>
                            <ActiveLink path="/license">
                                License
                            </ActiveLink>
                        </li>
                        <li>
                            <ActiveLink path="/privacy">
                                Privacy Policy
                            </ActiveLink>
                        </li>
                        <li>
                            <ActiveLink path="/contact">
                                Contact Us
                            </ActiveLink>
                        </li>
                    </ul>
